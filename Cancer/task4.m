...
rng(8000,'twister');
% hold out performance measurment
holdoutCVP = cvpartition(grp,'holdout',56);
% assign the training part datasets and its associated label into variable
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Train Accuracy%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%%%%%%%%%%%%%
trainMCELocal = crossval(classf,obs(:,fs1(fsLocal)),grp,'partition',holdoutCVP)/holdoutCVP.TrainSize
...
testMCEResubfor16 = crossval(classf,obs(:,fsResubfor16),grp,'partition',holdoutCVP)/holdoutCVP.TestSize